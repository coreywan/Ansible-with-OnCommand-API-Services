...
def get():
    ...
    if portset_key != None:
        if flag is 0:
            ...
            url_path+="&portset_key="+portset_key
    if iscsi_portal_group_key != None:
        if flag is 0:
            url_path+="?iscsi_portal_group_key="+iscsi_portal_group_key
            flag=1
        else:
            url_path+="&iscsi_portal_group_key="+iscsi_portal_group_key
    if sortBy != None:
...
def post():
    ...
    if (iscsi_portal_group_key != None) & (iscsi_portal_group_key != key):
        payload['iscsi_portal_group_key']=iscsi_portal_group_key
...
def main():
        ...
        global iscsi_portal_group_key
        iscsi_portal_group_key = module.params["iscsi_portal_group_key"]
        global sortBy
